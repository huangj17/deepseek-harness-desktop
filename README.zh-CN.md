...
请选择对应系统的软件包。以下链接可直接下载 **0.2.10**：

| 系统 | 架构 | 软件包 | 下载 |
| --- | --- | --- | --- |
| macOS | Apple 芯片 | DMG | [直接下载](https://github.com/huangj17/deepseek-harness-desktop/releases/download/v0.2.10/DeepSeek-Harness-0.2.10-arm64.dmg) |
| macOS | Intel | DMG | [直接下载](https://github.com/huangj17/deepseek-harness-desktop/releases/download/v0.2.10/DeepSeek-Harness-0.2.10-x64.dmg) |
| Windows | x64 | 安装程序 | [直接下载](https://github.com/huangj17/deepseek-harness-desktop/releases/download/v0.2.10/DeepSeek-Harness-0.2.10-x64.exe) |
| Windows | x64 | 便携 ZIP | [直接下载](https://github.com/huangj17/deepseek-harness-desktop/releases/download/v0.2.10/DeepSeek-Harness-0.2.10-x64.zip) |
| Linux | x64 | AppImage | [直接下载](https://github.com/huangj17/deepseek-harness-desktop/releases/download/v0.2.10/DeepSeek-Harness-0.2.10-x64.AppImage) |
| Debian / Ubuntu | x64 | deb | [直接下载](https://github.com/huangj17/deepseek-harness-desktop/releases/download/v0.2.10/DeepSeek-Harness-0.2.10-x64.deb) |

[查看全部发布文件及 SHA-256 校验值](https://github.com/huangj17/deepseek-harness-desktop/releases/tag/v0.2.10)。
